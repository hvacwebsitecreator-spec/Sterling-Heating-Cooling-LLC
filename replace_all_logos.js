...
text = text.replace(/<img class="footer-logo" src="sterling-logo\.png"[^>]*>/gi, '<img class="footer-logo" src="sterling-logo.png" alt="Sterling Heating and Cooling logo" />');
fs.writeFileSync(path, text, 'utf8');
console.log('replaced all embedded logo images with sterling-logo.png');
